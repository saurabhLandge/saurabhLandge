...
### ⚡ Fun fact: 
####  In a team of two, I developed a small application to display wind speed information from a remotely located sensor to Computer operating inside the Nuclear Power Plant's Control Room. Visual basic and SQL were used to create this application. To highlight, Power Plant Control Rooms are the most secure places on Earth. No one can go in there without highest security clearance.
